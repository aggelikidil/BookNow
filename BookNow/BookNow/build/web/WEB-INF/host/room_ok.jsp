            ...
            <div class="container">
                <div class="main">
                    <div class="details">
                        ...
                        <div>
                            <p class="para">You have created the room successfully!!!</p>
                            <p class="para">Don't forget to check our latest offers !!!!!!</p>
                            
                            <div class="read_more">
                                <center><a href="${pageContext.request.contextPath}/host/rooms/create">you may create a new room whenever you want!!!</a></center>
                            </div>
                        </div>
                    </div>
                </div>		
