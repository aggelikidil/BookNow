    ...
    <body>
        ...
        <div class="main_bg">
            <div class="container">
                <div class="main">
                    <div class="details">
                        <a href="#"><h2>Welcome Mr ${my_name} !!! </h2></a>
                        <div>
                            <p class="para">You have deleted the message successfully!!!</p>
                            ...
                            <div class="read_more">
                                <center><a href="${pageContext.request.contextPath}/contact/outbox">you can check your outbox whenever you want!!!</a></center>
                            </div>
                        </div>
                    </div>
                </div>		
