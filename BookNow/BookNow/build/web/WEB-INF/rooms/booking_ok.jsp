            ...
            <div class="container">
                <div class="main">
                    <div class="details">
                        ...
                        <div>
                            <p class="para">You have booked the room successfully!!!</p>
                            <p class="para">Don't forget to check our latest offers !!!!!!</p>

                            <div class="read_more">
                                <center><a href="${pageContext.request.contextPath}/booking">you may book another room whenever you want!!!</a></center>
                            </div>
                        </div>
                    </div>
                </div>		
