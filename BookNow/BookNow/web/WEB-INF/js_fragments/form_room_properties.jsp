                ...
                <div class="contact_right">
                    <div class="contact-form">
                        ...
                        <c:if test="${DETAILS.smoking}" >
                            <input type="checkbox" name="smoking" value="smoking" checked="true"> SMOKING<br>
                        </c:if>
                        <c:if test="${not DETAILS.smoking}" >
                            <input type="checkbox" name="smoking" value="smoking"> SMOKING<br>
                        </c:if>
                        ...
                        <c:if test="${DETAILS.event}" >
                            <input type="checkbox" name="event" value="event" checked="true"> EVENTS<br>
                        </c:if>
                        <c:if test="${not DETAILS.event}" >
                            <input type="checkbox" name="event" value="event"> EVENTS<br>
                        </c:if>
                        ...
                        <br/>
                        <h5><b>BEDS</b></h5>
                        <input type="text" value="${DETAILS.beds}" >
                        <br/>
                        <h5><b>BATHROOMS</b></h5>
                        <input type="text" value="${ROOM.bathrooms}" >
                        <br/>
                        <h5><b>BEDROOMS</b></h5>
                        <input type="text" value="${ROOM.bedrooms}"  >
                        <br/>
                        <h5><b>MINIMUM DATES</b></h5>
                        <input type="text" value="${DETAILS.minimum_dates}"  >
                        <br/>
                        <h5><b>MAX COST</b></h5>
                        <input type="text" value="${ROOM.max_cost}"  >
                        <br/>
                        <h5><b>MAX PEOPLE</b></h5>
                        <input type="text" value="${ROOM.max_people}"  >
                        <br/>
                        <h5><b>MIN COST</b></h5>
                        <input type="text" value="${ROOM.min_cost}"  >
                        <br/>
                        <h5><b>EXTRA COST PER PERSON</b></h5>
                        <input type="text" value="${ROOM.extra_cost_per_person}"  >
                        <br/>
                        <h5><b>NEIGHBOURHOOD</b></h5>
                        <input type="text" value="${DETAILS.neighbourhood}"  >
                        <br/>
                        <h5><b>PUBLIC TRANSPORT</b></h5>
                        <input type="text" value="${DETAILS.public_transport}" >
                        <br/>
                        <h5><b>PHOTO URL</b></h5>
                        <input type="text" value="${ROOM.thumbnail_url}"  >
                        <br/>

                        <h5><b>DESCRIPTION</b></h5>
                        <input type="text"  value="${ROOM.description}" >
                        <br/>


                        <form action="${pageContext.request.contextPath}/host/rooms/properties?id=${obj.id}" method="POST">
                            <input type="submit" value="Save changes" />
                        </form>

                        <form action="${pageContext.request.contextPath}/host/rooms" method="POST">
